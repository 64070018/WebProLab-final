...
router.put('/comments/:commentId', isLoggedIn, blogComment, async function (req, res, next) {
    try {
...
// Delete comment
router.delete('/comments/:commentId', isLoggedIn, blogComment, async function (req, res, next) {
    try {
        const [rows1, fields1] = await pool.query(
