      ...
      <div class="content">
        <div class="card has-background-light">
          ...
          <footer class="card-footer">
            ...
            >
            <a
              v-if="user.id === blog.create_by_id || user.role === 'admin'"
...
export default {
  // if you want to access user data will have props: ['user] => data from backend
  props: ["user"],
  data() {
    return {
      blog: {},
  ...
  methods: {
    ...
    addLikeComment(commentId) {
      axios
        .put(`/comments/addlike/${commentId}`)
        .then((response) => {
